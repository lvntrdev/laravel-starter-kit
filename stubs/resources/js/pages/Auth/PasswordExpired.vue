    ...
    <AuthLayout :title="$t('sk-auth.password_expired_page.title')">
        ...
        <form class="auth-form" @submit.prevent="submit">
            ...
            <div class="auth-form__field">
                <label for="current_password" class="auth-form__label">
                ...
                <small v-if="form.errors.current_password" class="auth-form__error">
        ...
        <template #footer>
            <Link href="/logout" method="post" as="button" class="auth-link">
